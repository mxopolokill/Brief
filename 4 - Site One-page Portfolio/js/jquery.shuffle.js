  ...
  Shuffle.prototype = {
    _init: function () {
      var self = this,
        ...
        debouncedResize = self.throttle
          ? self.throttle(self.throttleTime, resizeFunction)
          : resizeFunction,
      ...
      if (self.supported) {
        setTimeout(function () {
          ...
          self.$el[0].style[TRANSITION] =
            "height " + self.speed + "ms " + self.easing;
        }, 0);
      }
    },
    ...
    _setVars: function () {
      ...
      if (typeof columnWidth === "string") {
        ...
        columnWidth &&
        columnWidth.nodeType &&
        columnWidth.nodeType === 1
      ) {
        // Wrap it in jQuery
    ...
    _setSequentialDelay: function ($collection) {
      ...
      $.each($collection, function (i) {
        ...
        this.style[TRANSITION_DELAY] =
          "0ms," + (i + 1) * self.sequentialFadeDelay + "ms";
    ...
    _getOuterWidth: function (element, includeMargins) {
      ...
      if (includeMargins) {
        ...
        var marginRight =
          Math.round(parseFloat(element.style.marginRight)) || 0;
    ...
    _setColumns: function (theContainerWidth) {
      var containerWidth =
        theContainerWidth || this._getOuterWidth(this.$el[0]);
    ...
    _reLayout: function (callback, isOnlyPosition) {
      ...
      if (self.keepSorted && self.lastSort) {
        ...
        self._layout(
          self.$items.filter(".filtered").get(),
          self.filterEnd,
          isOnlyPosition
        );
      }
    ...
    destroy: function () {
      ...
      self.$el.removeClass(SHUFFLE).removeAttr("style").removeData(SHUFFLE);
